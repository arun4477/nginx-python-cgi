...
PASSWORD_5PAISA = form.getvalue('5paisa-password')
DOB_YYYYMMDD = form.getvalue('dob')

APP_NAME = form.getvalue('appname')
APP_SOURCE = form.getvalue('appsource')
USER_ID = form.getvalue('userid')
PASSWORD = form.getvalue('password')
USER_KEY = form.getvalue('userkey')
ENCRYPTION_KEY = form.getvalue('encryptionkey')
