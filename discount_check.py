...
class FetchOptionData:
    ...
    while True:
      if self.is_parallel_run:
        try:
          ...
          time.sleep(2)
          print('<script type="text/javascript">document.body.innerHTML = "";</script>')
          #print('<script type="text/javascript">document.getElementById("red").innerHTML = "";</script>')
          #print('<script type="text/javascript">document.getElementById("blue").innerHTML = "";</script>')
  ...
  def convert_df_to_html(self, index, spot_value, fut_value, percentage_diff, cheap_style, class_name, *dfs):
    ...
    html += '<div id="red" style="padding-left:100px; padding-right:100px; background-color:red;">'
    for df in dfs:
        html += df.T.to_html()
    html += '</div>'
  ...
  def index_stack(self, dfs):
    html = '<div id="blue" style="width: 100%; background-color: blue;">'
